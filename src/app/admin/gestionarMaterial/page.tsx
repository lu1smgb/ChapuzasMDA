...
export default function GestionMaterial() {
  ...
  const menuItems = [
    { 
      ...
      description: 'Agregar un nuevo material al sistema', 
      icon: PlusSquare, 
      link: './gestionarMaterial/anadir',
      color: 'bg-green-500 hover:bg-green-600'
    },
    { 
      title: 'Modificar Material', 
      description: 'Editar información del material', 
      icon: Edit, 
      link: './gestionarMaterial/modificar',
      color: 'bg-blue-500 hover:bg-blue-600'
    },
    { 
      title: 'Eliminar Material', 
      description: 'Remover material del sistema', 
      icon: Trash2, 
      link: './gestionarMaterial/eliminar',
