...
export default function GestionProfesores() {
  ...
  const menuItems = [
    { 
      ...
      icon: UserPlus, 
      link: './gestionarProfesor/anadir',
      color: 'bg-green-500 hover:bg-green-600'
    },
    { 
      title: 'Modificar Profesor', 
      description: 'Editar información de profesores existentes', 
      icon: UserCog, 
      link: './gestionarProfesor/modificar',
      color: 'bg-blue-500 hover:bg-blue-600'
    },
    { 
      title: 'Eliminar Profesor', 
      description: 'Remover profesores del sistema', 
      icon: UserMinus, 
      link: './gestionarProfesor/eliminar',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex items-center justify-center p-4">
      <main className="bg-white/80 backdrop-blur-md rounded-lg shadow-lg p-6 w-full max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-center text-gray-900">Gestión de Profesores</h1>
