...
import { UserPlus, UserCog, UserMinus, BookOpen, ClipboardList, Send, Gamepad2 } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { 
      ...
      description: 'Asignar tareas a alumnos o grupos', 
      icon: Send, 
      link: '/admin/assign-tasks',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex items-center justify-center p-4">
      <main className="bg-white/80 backdrop-blur-md rounded-lg shadow-lg p-6 w-full max-w-5xl">
        <h1 className="text-4xl font-bold mb-8 text-center text-gray-900">Menú Administrador</h1>
